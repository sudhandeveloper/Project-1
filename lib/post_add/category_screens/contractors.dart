...
class postContractors extends StatefulWidget {
  const postContractors({Key? key}) : super(key: key);

  @override
  State<postContractors> createState() => _postContractorsState();
}

class _postContractorsState extends State<postContractors> {
...
//image picker
  ...
  Future uploadImage() async {
    ...
    // CollectionReference postContractors =  firebaseFirestore.collection("Users").doc(add("postContractors", "Images")) as CollectionReference<Object?>;
    //
  }
                              ...
                              child: ElevatedButton(
                                  onPressed: () {
                                    ...
                                    if (_formkey.currentState!.validate()) {
                                      ...
                                      //Add a new item
                                      postContractors.add(dataToSend);
                                    }
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
